...
router.post("/api/document/attribute", VerifyToken.checkout, Document.attribute);
...
router.post("/api/document/permission", VerifyToken.checkout, Document.permission);
