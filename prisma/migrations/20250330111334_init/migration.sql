...
-- CreateEnum
CREATE TYPE "DocumentStateEnum" AS ENUM ('DENY', 'ACCESS', 'REJECT', 'FORWARD', 'PENDING');
...
CREATE TABLE "DocumentAttribute" (
    "categoryMain" VARCHAR(500) NOT NULL,
...
-- CreateTable
CREATE TABLE "_report_document" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_report_document_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "DepartmentEmployeeRole_employee_id_idx" ON "DepartmentEmployeeRole"("employee_id");

-- CreateIndex
CREATE INDEX "DepartmentEmployeeRole_documentId_idx" ON "DepartmentEmployeeRole"("documentId");

-- CreateIndex
CREATE UNIQUE INDEX "DepartmentEmployeeRole_employee_id_documentId_key" ON "DepartmentEmployeeRole"("employee_id", "documentId");
...
-- CreateIndex
CREATE INDEX "_report_document_B_index" ON "_report_document"("B");
...
-- AddForeignKey
ALTER TABLE "UsedPhone" ADD CONSTRAINT "UsedPhone_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_report_document" ADD CONSTRAINT "_report_document_A_fkey" FOREIGN KEY ("A") REFERENCES "Document"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_report_document" ADD CONSTRAINT "_report_document_B_fkey" FOREIGN KEY ("B") REFERENCES "report_document"("id") ON DELETE CASCADE ON UPDATE CASCADE;
