"use client";
import { Modal, Form, Input, Table, Button, Select, Layout } from "antd";
import type { ColumnsType } from "antd/es/table";
import { convertUtil, capitalizeFirstLetter } from "../../usable";
...
export function FirstCheckout({ open, onCancel, documentId }: ModalProps) {
