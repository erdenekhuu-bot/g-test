...
import { ReadTestSchedule } from "../ReadTestSchedule";
import { ReadTestRisk } from "../ReadTestRisk";
import { ReadTestEnv } from "../ReadTestEnv";
import { ReadTestCase } from "../ReadTestCase";
import { Badge } from "@/components/ui/badge";
import { globalState } from "@/app/store";
import { useRouter } from "next/navigation";
import { ReadDepartmentEmployee } from "../ReadDepartmentEmployee";
...
export const AccessDetailDocument = createContext<any | null>(null);

export function AccessDetail({ document, step }: any) {
  ...
  return (
    <Form form={attributeForm} className="p-4 flex gap-x-8">
      <AccessDetailDocument.Provider value={document}>
